package com.liar.server.info.common.bean;

import com.liar.server.user.common.bean.ResultMap;
                ...
                for (Map.Entry<String, Object> entry : set) {
                    ...
                    if (o == null)
                        ...
                        if (List.class.isAssignableFrom(o.getClass())) {
                            com.liar.server.user.common.bean.ResultList list = new com.liar.server.user.common.bean.ResultList();
                            list.setBody((List) o);
            ...
            try {
                ...
                if (o == null) {
                    ...
                    // 数组没有处理
                        ...
                        value = new Type();
                        com.liar.server.user.common.bean.ResultList listt = new com.liar.server.user.common.bean.ResultList();
                        listt.setBody(list);
